# -*- coding: utf-8 -*-
"""
MNN Taint Analyzer - Framework Version
...
class MNNAnalyzer(GhidraScript):
    """MNN taint analyzer using the modular framework."""
    ...
    def run(self):
        ...
        self.println("Starting MNN taint analysis (Framework Version)...")
        ...
        # Configure MNN source
        # getSessionOutput is the main function that returns inference results
        source = KeywordTaintSource("getSessionOutput", "contains")
        ...
        self.println("\nMNN Framework Analyzer finished.")
