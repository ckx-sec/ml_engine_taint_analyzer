...
class TaintAnalyzer:
    ...
    def _get_stack_offset_from_varnode_recursive(self, varnode, high_func, recursion_depth=0, max_depth=5):
        """
        Recursively unwraps operations to find the underlying stack offset from a varnode.
        This is a more robust way to track stack variables compared to simple heuristics.
        It can handle direct stack addresses, offsets from SP/FP, and chained PTRADDs.
        """
